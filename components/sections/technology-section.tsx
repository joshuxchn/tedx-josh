...
export function TechnologySection() {
  ...
  const descriptionText = "TEDxUIUC brings visionary thinkers to campus. From groundbreaking research to creative innovation, our speakers share ideas that challenge perspectives. Join hundreds of curious minds for a day of inspiration, connection, and transformation at the University of Illinois.";
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              {/* Image 1 - Base layer - Conference venue */}
              <Image

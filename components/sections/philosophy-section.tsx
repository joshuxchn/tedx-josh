      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("TEDx is a global grassroots initiative, inspired by TED's mission to share 'ideas worth spreading.' Locally organized events feature live speakers and TED Talks, fostering community conversations and innovation. Over 3,000 events occur annually, independently organized under TED's guidelines.").split(" ").map((word, index, array) => {

      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              {/* Text Overlay - Fades out first */}
              <div 
                className="absolute inset-0 z-20 flex items-center justify-center"
                style={{ opacity: textOpacity }}
              >
                <h1 className="whitespace-nowrap text-[35vw] font-bold leading-[0.8] tracking-tighter text-white mix-blend-difference">
              ...
              <Image
                src="https://images.unsplash.com/photo-1560523159-4a9692d222ef?w=1600&q=80"
                alt="TEDx stage with dramatic red lighting"
                fill
